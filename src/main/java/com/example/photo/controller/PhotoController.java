...
import com.example.photo.AnalyzePhotos;
import com.example.photo.service.S3Service;
import com.example.photo.WriteExcel;
...
public class PhotoController {
    ...
    return s3Client.ListAllObjects("photo.analyse");
    }
    ...
    String report(HttpServletRequest request, HttpServletResponse response) {
       ...
       List myKeys =  s3Client.ListBucketObjects("photo.analyse");
       ...
       for (int z=0 ; z < len; z++) {
           ...
           byte[] keyData = s3Client.getObjectBytes ("photo.analyse", key);
    ...
    public ModelAndView singleFileUpload(@RequestParam("file") MultipartFile file) {
        ...
        try {
           ...
           // Put the file into the bucket
            s3Client.putObject(bytes, "photo.analyse", name);
